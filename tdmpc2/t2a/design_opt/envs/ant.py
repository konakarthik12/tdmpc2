...
from t2a.khrylib.rl.envs.common.mujoco_env_gym import MujocoEnv
from t2a.khrylib.robot.xml_robot import Robot
from t2a.khrylib.utils import get_single_body_qposaddr, get_graph_fc_edges
from t2a.khrylib.utils.transformation import quaternion_matrix
...
class AntEnv(MujocoEnv, utils.EzPickle):
    def __init__(self, cfg, agent):
        ...
        self.agent = agent
        self.model_xml_file = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../assets/mujoco_envs/ant.xml'))
        ...
        self.stage = "execution"        # @sanghyun: only execution for now
        ...
        # @sanghyun
        done_condition = cfg.done_condition
        max_nsteps = done_condition.get('max_nsteps', 1000)
        self.max_episode_steps = max_nsteps
    ...
    def action_to_control(self, a):
        ...
        for body, body_a in zip(self.robot.bodies[1:], a):
    ...
    def step(self, a):
        ...
        # execution stage
            ...
            return ob, reward, done, {'use_transform_action': False, 'stage': 'execution', 'success': False}
