import numpy as np
import tdmpc2.envs.omnigib.robots.ant as ant
import omnigibson as og
from omnigibson.robots import REGISTERED_ROBOTS

og.log.info("Ant test")
...
assert "Ant" in REGISTERED_ROBOTS, "Ant robot not found in REGISTERED_ROBOTS"
robot_name = "Ant"
robot_cls = REGISTERED_ROBOTS[robot_name]
