...
class CollectPPO(PPO):
    ...
    def collect_rollouts(
        ...
        @ sanghyun:
        - After each episode ends, if the accumulated reward is larger than
        the current best reward, save the trajectory in the log directory.
        """
        ...
        while n_steps < n_rollout_steps:
            ...
            '''
            ========================
            @sanghyun: Collect trajectory.
            A single segment of trajectory is comprised of 
            - prev observation (real obs, rgb rendering)
            - action
            - reward
            - next observation (real obs, rgb rendering)
